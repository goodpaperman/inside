// ex34a.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CEx34aApp, CWinApp)
 //{{AFX_MSG_MAP(CEx34aApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEx34aApp object

CEx34aApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CEx34aApp initialization

BOOL CEx34aApp::InitInstance()
{
 ...
 pDocTemplate = new CSingleDocTemplate(
  IDR_MAINFRAME,
  RUNTIME_CLASS(CEx34aDoc),
  RUNTIME_CLASS(CMainFrame),       // main SDI frame window
  RUNTIME_CLASS(CEx34aView));
...
BOOL CEx34aApp::OnIdle(LONG lCount) 
{
